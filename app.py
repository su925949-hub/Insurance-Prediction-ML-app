...
# Web Page Code 
st.title("HEALTH INSURANCE PREDECTION")
image_url = "https://cdn.zeebiz.com/sites/default/files/2026/03/09/401943-health-insurance.png"
st.image(img_url)

# LOAD DATA and MODEL PART
...
# show data sample 
st.write(df.head())
# Create Side bar for user unput form
